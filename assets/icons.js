...
export const ICONS = {
	 ...
	 */
	lock: `<svg viewBox="0 0 24 24" fill="none" stroke="#E5484D" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><rect x="4.7" y="10.3" width="14.6" height="10.5" rx="2.9"/><path d="M8.3 10.3V7.5a3.7 3.7 0 0 1 7.05-1.5"/><circle cx="12" cy="14.7" r="1.45" fill="#E5484D" stroke="none"/><path d="M12 15.5v2.3"/></svg>`,
	unlock: `<svg viewBox="0 0 24 24" fill="none" stroke="#FFFFFF" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><rect x="4.7" y="10.3" width="14.6" height="10.5" rx="2.9"/><path d="M8.3 10.3V7.7a3.7 3.7 0 0 1 7.4 0v2.6"/><circle cx="12" cy="14.7" r="1.45" fill="#FFFFFF" stroke="none"/><path d="M12 15.5v2.3"/></svg>`,
